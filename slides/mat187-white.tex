...
\begin{slide}
	...
	\begin{parts}
		...
		\begin{enumerate}
			...
			\item $\displaystyle g_3(x)=\frac{1}{1+(2x)^4}$
		\end{enumerate}
	\end{parts}
...
\begin{slide}
	\question
	A bee is flying through the air looking for a delicious nectar snack. The Corn Marigold 
	flower is known to be a great source of nectar. 

	The bee's distance from a Corn Marigold flower at time $t$ is given by $d(t)$.
