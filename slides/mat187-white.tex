...
\begin{slide}
	...
	\begin{parts}
		...
		\item Using the fact that for any $\alpha\in \R$, $\lim_{n\to\infty} \frac{\alpha^n}{n!}=0$, find $\lim_{k\to\infty} R_k(x)$.
...
\begin{slide}
	...
	\begin{parts}
		...
		\url{https://www.desmos.com/calculator/yi4qczkxqn}
...
\begin{slide}
	...
	\[
		T(x)=\sum_{n=0}^\infty (-1)^{n+1}\frac{x^{2n+1}}{(2n+1)!}
	\]
	be the Taylor series for $f$ centered at $0$. We know that
	$f(x)=T(x)$ for all $x\in \R$.

	\begin{parts}
		\item Find a series representation for $g_1(x)=\sin(2x)$ (without 
		computing any derivatives).
		\item Find a series representation for $g_2(x)=\sin(x^2)$.
...
\begin{slide}
	...
	\begin{parts}
		...
		computing any derivatives).
		\item For which $x$ do you expect $g_2(x)$ to be valid? Explain.
