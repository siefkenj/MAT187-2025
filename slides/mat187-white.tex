...
\begin{slide}
	...
	\begin{parts}
		...
		\item Use the trig identity $\displaystyle\sin^2\theta = \frac{1-\cos 2x}{2}$
		to find $F(x)$.
	\end{parts}
\end{slide}
...
\begin{slide}
	...
	\begin{parts}
		...
		$\mathrm d x$ equal?
		\item Apply the substitution $x=\sin\theta$ we get a new function
		 $g(\theta)$ so that 
		 \[
...
\begin{slide}
	...
	\begin{parts}
		...
		Does WolframAlpha give you a useful answer?
		 ...
		 approximate $I$.
		 \item Desmos claims $I\approx 0.51154910026$. Which of your estimates is more accurate?
