...
\begin{slide}
	...
	\begin{parts}
		\item On each interval, identify whether left/right/midpoint/trapezoid will produce a
		\begin{enumerate}
			\item Underestimate 
			\item Overestimate 
...
\begin{slide}
	...
	\begin{parts}
		...
		\item Make a plot of $n$ vs. $a_n$ and $n$ vs. $b_n$.
		\item Which sequences of $a_n$ and $b_n$ are (i) bounded above, (ii) bounded below,
		...
		\item Based on your answer to Part 3, will $c_n$ be bounded above or below?	
