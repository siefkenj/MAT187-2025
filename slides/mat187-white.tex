...
\begin{slide}
	...
	The bee's displacement from a Corn Marigold flower at time $t$ is given by $d(t)$.
	...
	\begin{parts}
		\item Estimate the displacement of the bee from the flower at time 
		...
		\item Are there any times you can compute the \emph{exact} displacement the bee is from the flower?
